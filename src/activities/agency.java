...
public class agency extends javax.swing.JFrame {
   ...
   private Connection con;
        ...
        Double amount;
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        i++;
                        DefaultTableModel model = (DefaultTableModel) agencytable.getModel();
                        model.addRow(new Object[]{name,email,gst,amount});
                    }
                }
    ...
    private void initComponents() {
        ...
        listofagencytitle = new javax.swing.JLabel();
        ...
        inputgstinTF = new javax.swing.JTextField();
        inputnamelabel = new javax.swing.JLabel();
        inputemaillabel = new javax.swing.JLabel();
        inputgstinlabel = new javax.swing.JLabel();
        ...
        listofagencytitle.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        listofagencytitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        listofagencytitle.setText("List of Agency");
        ...
        inputgstinlabel.setText("Enter GSTIN");
        ...
        rightpanelLayout.setHorizontalGroup(
            ...
            .addComponent(listofagencytitle, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(rightpanelLayout.createSequentialGroup()
                        ...
                        .addGroup(rightpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(rightpanelLayout.createSequentialGroup()
                                ...
                                .addComponent(inputgstinTF, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            ...
                            .addGroup(rightpanelLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(inputgstinlabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        rightpanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {inputamountTF, inputamountlabel, inputemailTF, inputemaillabel, inputgstinTF, inputgstinlabel, inputnameTF, inputnamelabel});

        rightpanelLayout.setVerticalGroup(
            rightpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(rightpanelLayout.createSequentialGroup()
                .addComponent(listofagencytitle)
                .addGap(4, 4, 4)
                ...
                .addGroup(rightpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(inputgstinTF, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void addbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addbuttonActionPerformed
        ...
        String gstin= inputgstinTF.getText();
        String amount= inputamountTF.getText();
        if(name.isEmpty() || email.isEmpty() || gstin.isEmpty() || amount.isEmpty()){
            JOptionPane.showMessageDialog(this,"Please Enter all fields","Try again", JOptionPane.ERROR_MESSAGE);
        }
        else{
        PreparedStatement quer;
                String sql = "insert into agency(name,gst,amount)values(?,?,?);";
                try {
                    quer=con.prepareStatement(sql);
                    quer.setString(1, name);
                    quer.setString(2, gstin);
            ...
            DefaultTableModel model = (DefaultTableModel) agencytable.getModel();
            model.addRow(new Object[]{name,email,gstin,amount});
            inputnameTF.setText("");
            inputemailTF.setText("");
            inputgstinTF.setText("");
    ...
    private void deletebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebuttonActionPerformed
        ...
        if(row<0){
            JOptionPane.showMessageDialog(this,"No Agency is selected! please Select one Agency","Select Row",JOptionPane.ERROR_MESSAGE);
        }
        else{
            DefaultTableModel model = (DefaultTableModel) agencytable.getModel();
            String agency = (String) model.getValueAt(row, 0);
            PreparedStatement quer;
                String sql = "DELETE from agency where name = ?";
                try {
                    quer=con.prepareStatement(sql);
                    quer.setString(1, agency);
                    quer.executeUpdate();
                }
                catch (SQLException ex) {
                    Logger.getLogger(loginDemo.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField inputgstinTF;
    private javax.swing.JLabel inputgstinlabel;
    private javax.swing.JTextField inputnameTF;
    private javax.swing.JLabel inputnamelabel;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JPanel leftpanel;
    private javax.swing.JLabel listofagencytitle;
